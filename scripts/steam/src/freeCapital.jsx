    ...
    return(
      <section className="cnt_date">
        ...
        <p>
          ...
          <Button txt='充值' id='cnt_in'/>
          <Button txt='提现' id='cnt_out'/>
        </p>
      </section>
    )
  }
...
const Footer=(props)=>{
  ...
  return (
    <section className='cnt_footer'>
      <span>提现金额：{outNum}，</span>
      <span>充值金额：{inNum}，</span>
      <span>还款金额：{reNum}</span>
    </section>
  )
}
...
class Main extends React.Component{
  ...
  getData({accountName='SYS_GENERATE_000',start_time='',end_time='',page_size=20,p=this.p}){
    const self=this;
    $.ajax({
